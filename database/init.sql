...
CREATE TABLE `city` (
    ...
    `location_id` VARCHAR(20) COMMENT '和风天气位置ID',
    `status` TINYINT NOT NULL DEFAULT 1 COMMENT '1启用 0禁用',
    `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `operation_log` (
    ...
    `action` VARCHAR(50) NOT NULL COMMENT '操作类型: register/login/update/delete/create',
...
-- 插入城市数据（按省份分组排列）
INSERT INTO `city` (`id`, `name`, `province`, `latitude`, `longitude`, `category`, `location_id`) VALUES
-- 直辖市
(1, '北京市', '北京', 39.9042, 116.4074, '直辖市', '101010100'),
(2, '上海市', '上海', 31.2304, 121.4737, '直辖市', '101020100'),
(3, '天津市', '天津', 39.1252, 117.1908, '直辖市', '101030100'),
(4, '重庆市', '重庆', 29.4316, 106.9123, '直辖市', '101040100'),
-- 河北
(5, '石家庄市', '河北', 38.0455, 114.5093, '省会城市', '101090101'),
-- 山西
(6, '太原市', '山西', 37.8706, 112.5509, '省会城市', '101100101'),
(7, '临汾市', '山西', 36.0880, 111.5189, '地级市', '101100702'),
-- 内蒙古
(8, '呼和浩特市', '内蒙古', 40.8422, 111.7498, '省会城市', '101080101'),
-- 辽宁
(9, '沈阳市', '辽宁', 41.8057, 123.4315, '省会城市', '101070101'),
-- 吉林
(10, '长春市', '吉林', 43.8961, 125.3265, '省会城市', '101060101'),
-- 黑龙江
(11, '哈尔滨市', '黑龙江', 45.8038, 126.5350, '省会城市', '101050101'),
-- 江苏
(12, '南京市', '江苏', 32.0603, 118.7969, '省会城市', '101190101'),
-- 浙江
(13, '杭州市', '浙江', 30.2741, 120.1551, '省会城市', '101210101'),
-- 安徽
(14, '合肥市', '安徽', 31.8206, 117.2272, '省会城市', '101220101'),
-- 福建
(15, '福州市', '福建', 26.0745, 119.2965, '省会城市', '101230101'),
-- 江西
(16, '南昌市', '江西', 28.6829, 115.8580, '省会城市', '101240101'),
-- 山东
(17, '济南市', '山东', 36.6512, 117.1201, '省会城市', '101120101'),
-- 河南
(18, '郑州市', '河南', 34.7466, 113.6253, '省会城市', '101180101'),
(19, '安阳市', '河南', 36.0985, 114.3924, '地级市', '101180201'),
-- 湖北
(20, '武汉市', '湖北', 30.5928, 114.3055, '省会城市', '101200101'),
-- 湖南
(21, '长沙市', '湖南', 28.2282, 112.9388, '省会城市', '101250101'),
-- 广东
(22, '广州市', '广东', 23.1291, 113.2644, '省会城市', '101280101'),
-- 广西
(23, '南宁市', '广西', 22.8170, 108.3665, '省会城市', '101300101'),
-- 海南
(24, '海口市', '海南', 20.0440, 110.3499, '省会城市', '101310101'),
-- 四川
(25, '成都市', '四川', 30.5728, 104.0668, '省会城市', '101270101'),
-- 贵州
(26, '贵阳市', '贵州', 26.6470, 106.6302, '省会城市', '101260101'),
-- 云南
(27, '昆明市', '云南', 25.0389, 102.7183, '省会城市', '101290101'),
(28, '曲靖市', '云南', 25.4900, 103.8000, '地级市', '101290201'),
(29, '玉溪市', '云南', 24.3500, 102.5500, '地级市', '101290701'),
(30, '保山市', '云南', 25.1200, 99.1700, '地级市', '101290501'),
(31, '昭通市', '云南', 27.3400, 103.7200, '地级市', '101291001'),
(32, '丽江市', '云南', 26.8721, 100.2299, '地级市', '101291401'),
(33, '普洱市', '云南', 22.7800, 100.9700, '地级市', '101290901'),
(34, '临沧市', '云南', 23.8800, 100.0800, '地级市', '101291101'),
(35, '楚雄市', '云南', 25.0400, 101.5500, '县级市', '101290801'),
(36, '蒙自市', '云南', 23.3700, 103.4000, '县级市', '101290301'),
(37, '文山市', '云南', 23.3700, 104.2400, '县级市', '101290601'),
(38, '景洪市', '云南', 22.0000, 100.8000, '县级市', '101291601'),
(39, '大理市', '云南', 25.6065, 100.2676, '县级市', '101290204'),
(40, '芒市', '云南', 24.4300, 98.5800, '县级市', '101291501'),
(41, '泸水市', '云南', 25.8200, 98.8500, '县级市', '101291301'),
(42, '香格里拉市', '云南', 27.8300, 99.7000, '县级市', '101291201'),
-- 西藏
(43, '拉萨市', '西藏', 29.6500, 91.1409, '省会城市', '101140101'),
-- 陕西
(44, '西安市', '陕西', 34.2611, 108.9425, '省会城市', '101110101'),
-- 甘肃
(45, '兰州市', '甘肃', 36.0611, 103.8343, '省会城市', '101160101'),
-- 青海
(46, '西宁市', '青海', 36.6171, 101.7782, '省会城市', '101150101'),
-- 宁夏
(47, '银川市', '宁夏', 38.4872, 106.2309, '省会城市', '101170101'),
-- 新疆
(48, '乌鲁木齐市', '新疆', 43.8256, 87.6125, '省会城市', '101130101');
